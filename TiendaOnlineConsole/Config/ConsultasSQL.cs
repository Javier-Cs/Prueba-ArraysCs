...
namespace TiendaOnlineConsole.Config
{
    public static class ConsultasSQL
    {
        ...
        // Pedidos
        public static string Pedido_Insert = "INSERT INTO practica.Pedido_tbl (Cliente_id, Estado ,Total) VALUES (@ClienteId ,@Total); SELECT SCOPE_IDENTITY();"; // Retorna el ID del pedido
